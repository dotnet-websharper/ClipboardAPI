...
{
 "use strict";
 var WebSharper,Clipboard,Sample,Client,Operators,Obj,UI,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,TemplateHole,Var,Handler,Unchecked,WebSharper$Clipboard$Sample_Templates,TemplateHoleModule,VarStr,SC$1,Text,TextView,System,Guid,EventQ,JavaScript,Pervasives,Concurrency,Promise,EventTarget,Client$1,Templates,Doc,Collections,Dictionary,Node,Var$1,WindowOrWorkerGlobalScope,JS,Object,AsyncBody,CT,HashSet,Seq,TemplateInitializer,VarFloatUnchecked,VarBool,VarDateTime,VarFile,VarDomElement,View,Numeric,ConcreteVar,Snap,Scheduler,Error,NonStandardPromiseRejectionException,SC$2,DictionaryUtil,Enumerator,T,SC$3,Docs,DocElemNode,CharacterData,Abbrev,Fresh,OperationCanceledException,CancellationTokenSource,Blob,Elt,Element,Prepare,Slice,DomUtility,KeyCollection,An,Settings,Mailbox,Attrs,Dyn,Attrs$1,Elt$1,Attribute,Event,AttrModule,AttrProxy,AfterRender,AfterRenderQ,List,T$1,Strings,Array,Updates,ValueCollection,Docs$1,RunState,NodeSet,Anims,SC$4,HashSetUtil,SC$5,SC$6,SC$7,AppendList,DynamicAttrNode,KeyNotFoundException,SC$8,Easing,HashSet$1,BindVar,String,CheckedInput,DomNodes,Char,DateUtil,Lazy,SC$9,Queue,LazyExtensionsProxy,LazyRecord,Promise$1,console,Runtime$1,Math,Date;
 WebSharper=Global.WebSharper=Global.WebSharper||{};
 Clipboard=WebSharper.Clipboard=WebSharper.Clipboard||{};
 Sample=Clipboard.Sample=Clipboard.Sample||{};
 ...
 WebSharper$Clipboard$Sample_Templates=Global.WebSharper$Clipboard$Sample_Templates=Global.WebSharper$Clipboard$Sample_Templates||{};
 TemplateHoleModule=UI.TemplateHoleModule=UI.TemplateHoleModule||{};
 VarStr=TemplateHoleModule.VarStr=TemplateHoleModule.VarStr||{};
 SC$1=Global.StartupCode$WebSharper_Clipboard_Sample$Client=Global.StartupCode$WebSharper_Clipboard_Sample$Client||{};
 ...
 {
  var _,b,_this,_this$1,t,t$1,p,i;
  _=(b=(_this=(_this$1=(t=(t$1=new ProviderBuilder.New$1(),(t$1.h.push(Handler.EventQ2(t$1.k,"copytext",function()
  {
   return t$1.i;
  },function()
  {
   ...
   {
    return Concurrency.Bind(Promise.AsAsync(Client.copyText()),function()
    {
     return Concurrency.Return(null);
    });
   })),null);
  })),t$1)),(t.h.push(Handler.EventQ2(t.k,"pastetext",function()
  {
   return t.i;
  },function()
  {
   ...
   Concurrency.Start((_$1=null,Concurrency.Delay(function()
   {
    return Concurrency.Bind(Promise.AsAsync(Client.pasteText()),function()
    {
     return Concurrency.Return(null);
    });
   })),null);
  })),t)),(_this$1.h.push(new TextView.New("status",Client.statusMessage().get_View())),_this$1)),(_this.h.push(new VarStr.New("textinput",Client.textInput())),_this)),(p=Handler.CompleteHoles(b.k,b.h,[["textinput",0,null]]),(i=new TemplateInstance.New(p[1],WebSharper$Clipboard$Sample_Templates.main(p[0])),b.i=i,i))).get_Doc();
  Templates.LoadLocalTemplates("");
  Doc.RunById("main",_);
 };
 Client.textInput=function()
 {
  SC$1.$cctor();
  return SC$1.textInput;
 };
 ...
 Client.copyText=function()
 {
  ...
  function f()
  {
   function f$1()
   {
    return Client.clipboard().writeText(Client.textInput().Get()).then(function()
    {
     Client.statusMessage().Set("Copied to clipboard!");
     return Promise$1.resolve(null);
    });
   }
   function f$2(a)
   {
    console.error("Failed to copy:",a.message);
    Client.statusMessage().Set("Copy failed!");
    return Promise$1.resolve(null);
   }
 ...
 Client.pasteText=function()
 {
  ...
  function f()
  {
   function f$1()
   {
    return Client.clipboard().readText().then(function(a)
    {
     Client.textInput().Set(a);
     Client.statusMessage().Set("Pasted from clipboard!");
     return Promise$1.resolve(null);
    });
   }
   function f$2(a)
   {
    console.error("Failed to paste:",a.message);
    Client.statusMessage().Set("Paste failed!");
    return Promise$1.resolve(null);
   }
   return new Promise$1(function($1)
   {
 ...
 Client.clipboard=function()
 {
  SC$1.$cctor();
  return SC$1.clipboard;
 };
 ...
 WebSharper$Clipboard$Sample_Templates.main=function(h)
 {
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.statusMessage=Var$1.Create$1("");
  SC$1.textInput=Var$1.Create$1("");
  SC$1.clipboard=self.navigator.clipboard;
 };
